function [energy_total,Adot,Mdot,Sdot,Wdot,energy_model] = ...
    getMetabolicEnergySmooth2004all_multifibre(exc,act,lMtilde,vM,Fce,Fpass,...
...
F_iso_st = act(:, 1) .* Fiso .* Fmax .* pctst .* strength;
F_iso_ft = act(:, 2) .* Fiso .* Fmax .* pctft .* strength;
F_iso = F_iso_st + F_iso_ft;
